...
export function CreatePageContent () {
  ...
  const { getDraft, clearDraft, hasDraft } = useFormDraftStore()
      ...
      if (draft.characters.length > 0) {
        form.reset({
          characters: draft.characters.map(c => ({
            imageFile: c.imageFile || (undefined as unknown as File),
            name: c.name,
            age: c.age || (undefined as unknown as number),
            gender: c.gender || '',
            ...
            <FormProvider {...form}>
              <form onSubmit={onSubmit} className="space-y-4" aria-label="Storybook generator">
                ...
                <div className="space-y-3">
                  <div className={cn(
                    'grid gap-3',
                    characterCount === 1 && 'grid-cols-1',
                    characterCount === 2 && 'grid-cols-1 sm:grid-cols-2',
                    characterCount === 3 && 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3',
                    characterCount === 4 && 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-4'
                  )}>
