  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        description: 'Turn your photos into ultra-photorealistic storybooks with AI. Perfect for children\'s books, romantic love stories, pet adventures, retirement gifts, anniversaries, and more. Digital books $9.99, Premium Hardcover $39.99 in the US; local currency worldwide.',
      ...
      },
      {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Digital books are interactive HTML files you can view on any device and share instantly. Premium Hardcover books are professionally printed 8.5" × 8.5" physical books with 24 pages, premium color printing, matte finish—perfect as keepsake gifts. Prices are shown in your local currency.',
            },
          },
          {
            '@type': 'Question',
...
function HeroLeft () {
  return (
    <div className="flex min-w-0 flex-col sm:min-h-0">
      ...
      <DemoLoop className="mt-2 sm:mt-4 sm:flex-1">
        <HeroCoverImage />
      </DemoLoop>
    </div>
  )
