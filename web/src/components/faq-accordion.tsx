...
function faqItems (digitalPrice: string) {
  return [
    {
    ...
    },
    {
      ...
      a: `Not currently, but we recommend ordering the Digital Book first (${digitalPrice}) to see the full story and illustrations. If you love it, you can then order the Premium Hardcover version. The digital and physical versions contain identical content.`
    },
    {
      q: 'What payment methods do you accept?',
      a: 'We accept all major credit cards (Visa, Mastercard, American Express, Discover) and other payment methods through our secure payment processor. Prices are shown in your local currency. All transactions are encrypted and secure.'
    },
    {
...
export function FAQAccordion () {
  ...
  const faq = faqItems(prices.digital.price)
